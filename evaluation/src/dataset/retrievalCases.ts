...
export const RETRIEVAL_CASES: RetrievalCase[] = [
  ...
  // --- Phase 13, Milestone 13.6: hidden-style anti-overfitting cases,
  // against the warehouse-domain fixture added after all ranking work was
  // finalized. See docs/BENCHMARK_EXPANSION_PHASE_PLAN.md.
  {
    id: "retrieval-hidden-reserve-stock",
    query: "What function throws when there isn't enough available stock to fulfill a reservation?",
    expectedChunkIds: ["hidden-reserve-stock"],
    acceptableAlternativeChunkIds: [],
    notes: "Hidden-fixture case.",
    category: "natural-language-behavior",
    language: "typescript",
    difficulty: "medium",
  },
  {
    id: "retrieval-hidden-release-stock",
    query: "releaseStock",
    expectedChunkIds: ["hidden-release-stock"],
    acceptableAlternativeChunkIds: [],
    notes: "Hidden-fixture case, raw exact-identifier query.",
    category: "exact-function-name",
    language: "typescript",
    difficulty: "easy",
  },
  {
    id: "retrieval-hidden-delivery-estimate",
    query: "How is a shipment's estimated delivery date calculated?",
    expectedChunkIds: ["hidden-estimate-delivery-date"],
    acceptableAlternativeChunkIds: ["hidden-mark-shipment-delivered"],
    notes: "Hidden-fixture case.",
    category: "utility-function",
    language: "typescript",
    difficulty: "medium",
  ...
  {
    id: "retrieval-hidden-supplier-price-404",
    query: "Does fetching a supplier's price handle a 404 response correctly?",
    expectedChunkIds: ["hidden-fetch-supplier-price"],
    acceptableAlternativeChunkIds: [],
    notes: "Hidden-fixture case — a real reliability bug (404 silently treated as a $0 price).",
    category: "error-handling",
    language: "typescript",
    difficulty: "medium",
  },
  {
    id: "retrieval-hidden-low-stock-summary",
    query: "How does DevForge identify inventory items that are running low on stock?",
    expectedChunkIds: ["hidden-summarize-low-stock"],
    acceptableAlternativeChunkIds: [],
    notes: "Hidden-fixture case.",
    category: "no-exact-identifier",
    language: "typescript",
  ...
  {
    id: "retrieval-hidden-insufficient-evidence-returns",
    query: "How does the warehouse system process a customer return or refund of physical goods?",
    expectedChunkIds: [],
    acceptableAlternativeChunkIds: [],
    notes: "Hidden-fixture case: no returns/refund-of-goods code exists anywhere in the warehouse fixture.",
    category: "insufficient-evidence",
    language: "typescript",
    difficulty: "hard",
    answerable: false,
