...
export const FIXTURE_CHUNKS: FixtureChunk[] = [
  ...
  { chunkId: "py-deliver-internal", filePath: "python/services/email_service.py", symbolName: "_deliver", symbolType: "function", startLine: 10, endLine: 17, language: "python" },
  { chunkId: "py-send-email-async", filePath: "python/services/email_service.py", symbolName: "send_email_async", symbolType: "function", startLine: 20, endLine: 24, language: "python" },
